	...
	<div class="container">
		<div class="row">
			<div class="col-md-9">
				...
				<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="https://github.com/Azer266">https://github.com/Azer266</a></div>
			...
			<div class="col-md-3"><!--footer Share-->
				...
				<div class="fsoc">
					...
					<a href="https://<?php echo $ayarcek['ayar_google'] ?>" class="fflickr">google</a>
					<a href="https://<?php echo $ayarcek['ayar_youtube'] ?>" class="ffeed">youtube</a>
					<div class="clearfix"></div>
				</div>
				<div class="clearfix"></div>
			</div><!--footer Share-->
