...
<html lang="en">
  <head>
    ...
    <title>ModaBaz Online Store</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>ModaBaz Store</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cogs"></i> Site Ayarlari <span class="fa fa-cogs"></span></a>
                  ...
                  <li><a href="kullanici.php"><i class="fa fa-user"></i> Kullanicilar </a></li>
