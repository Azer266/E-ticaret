            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="urun-galeri.php?urun_id=<?php echo $uruncek['urun_id'] ?>"><center><button class="btn btn-success btn-xs">Resim Islemleri</button></center></a></td>
                  <td><?php echo $uruncek['urun_stok'] ?></td>
                  <td><center><?php 
                    if ($uruncek['urun_onecikar']==0) {?>
                      <a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id'] ?>&urun_one=1&urun_onecikar=ok"><button class="btn btn-success btn-xs">On Cikar</button></a>
                    <?php } 
                    elseif ($uruncek['urun_onecikar']==1) {?>
                      <a href="../netting/islem.php?urun_id=<?php echo $uruncek['urun_id'] ?>&urun_one=0&urun_onecikar=ok"><button class="btn btn-warning btn-xs">Kaldir</button></a>
                    <?php } ?> 
                   </td></center>
                  <td>
                    <center><?php 
