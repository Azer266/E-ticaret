...
<head>
	...
	<title><?php echo $uruncek['urun_ad'] ?> - Online Store</title>
</head>
				...
				<div class="col-md-6 det-desc">
					<div class="productdata">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="number" class="form-control" value="1" name="urun_adet">
							</div>
							...
							<div class="col-sm-4">
								...
								<button type="submit" name="sepetekle" disabled class="btn btn-default btn-red btn-sm"><span class="addchart">Uye Olun</span></button>
			...
			<div class="tab-review">
				<ul id="myTab" class="nav nav-tabs shop-tab">
					<li <?php if ($_GET['durum']!="ok") {?>
						class="active"
						<?php } ?>><a href="#desc" data-toggle="tab">Açıklama</a>
					</li>
					<li 
