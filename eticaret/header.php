					...
					<div class="col-md-8">
						<div class="pushright">
							<div class="top">
								...
								<a href="#" class="btn btn-default btn-dark">Hosgeldin<span>--</span><?php echo 
								$kullanicicek['kullanici_adsoyad'] ?></a>
								<?php  } ?>
								<div class="regwrap">
									<div class="row">
										<div class="col-md-6 regform">
											...
											<form action="nedmin/netting/islem.php" method="POST" role="form">
												<div class="form-group">
													<input type="text" class="form-control" name="kullanici_mail" id="username" placeholder="Kullanici adi">
												</div>
												<div class="form-group">
													<input type="password" class="form-control" name="kullanici_password" id="password" placeholder="Sifre">
												</div>
												<div class="form-group">
										...
										<div class="col-md-12">
											<form action="arama" method="POST" class="form-horizontal" role="form">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" name="aranan" minlength="3" required="" class="form-control" id="search">
													</div>
												</div>
											</form>
										</div>
					...
					<div class="row">
						<div class="col-md-10">
							...
							<div class="navbar-collapse collapse">
								...
								<div class="col-md-2 machart">
									...
									<div class="popcart">
										...
										<div class="popcart-tot">
											<p>
												Toplam Tutar<br>
												<span><?php echo $toplamfiyat ?> TL</span>
											</p>
										</div>
								...
								if (isset($_SESSION['userkullanici_mail'])) {?>
								<ul class="small-menu">
									<li><a href="hesabim.php" class="myacc">Hesab Bilgilerim</a></li>
									<li><a href="siparislerim.php" class="myshop">Siparislerim</a></li>
									<li><a href="logout.php" class="mycheck">Guvenli Cikis</a></li>
								</ul>
								<?php } ?>
